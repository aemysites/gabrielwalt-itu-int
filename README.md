...
## Environments
- Preview: https://main--gabrielwalt-itu-int--aemysites.aem.page/
- Live: https://main--gabrielwalt-itu-int--aemysites.aem.live/
- Block Library: https://main--gabrielwalt-itu-int--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `gabrielwalt-itu-int` directory in your favorite IDE and start coding :)
